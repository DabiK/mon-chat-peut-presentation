...
function initializeSmsPhoneDropdown(fieldName) {
  ...
  var smsField = Object.values({
    EMAIL: {
      ...
      type: "email",
      required: true,
      audience_field_name: "Adresse e-mail",
      merge_id: 0,
    ...
    LNAME: {
      ...
      type: "text",
      required: false,
      audience_field_name: "Nom de famille",
      enabled: false,
      order: null,
      field_type: "merge",
      merge_id: 2,
    ...
    PHONE: {
      ...
      type: "phone",
      required: false,
      audience_field_name: "Numéro de téléphone",
      phoneformat: "",
      enabled: false,
      order: null,
      field_type: "merge",
    ...
    interests_55255: {
      name: "interests_55255",
      label: "appLaunch",
      helper_text: "",
      type: "checkbox",
      required: false,
      choices: [
        { value: "1", label: "notify-app-lauch" },
        { value: "2", label: "notify-beta" },
      ],
      audience_field_name: "appLaunch",
      enabled: false,
      order: null,
      field_type: "group",
      group_id: 55255,
